window.addEventListener("DOMContentLoaded", (e) => {
	...
	document
		.querySelectorAll(".voteCount")
		.forEach((counter) => getVoteCount(counter)); //voteCounters for questions and answers should include this class
});
...
async function vote(e) {
	const clicked = e.target.id; // all question vote buttons need an id of the format upVoteFor40 or downVoteFor2020 generated by the templet
